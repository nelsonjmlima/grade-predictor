...
export default function ResetPasswordPage() {
  ...
  return <div className="min-h-screen w-full flex flex-col items-center justify-center p-4" style={{
      ...
      <div className="w-full max-w-md px-8 py-12">
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-gray-200 mt-2">
            {isUpdateMode ? "Enter your new password below" : "Enter your email to receive a password reset link"}
          </p>
        </div>
        ...
        <>
              {!passwordUpdated ? <>
                  ...
                  <CardContent className="space-y-4 px-8">
                    ...
                    field
                              ...
                              <FormControl>
                                <Input {...field} type="password" showPasswordToggle className="bg-white/10 border-white/20 text-white h-12 text-lg" placeholder="••••••••" />
                              </FormControl>
          ...
          <>
                  ...
                  <CardContent className="space-y-4 text-center px-8 py-8">
                    ...
                    <Button variant="outline" className="w-full bg-white/10 border-white/20 text-white hover:bg-white/20 mt-4" onClick={() => navigate("/")}>
        ...
        <>
              {!emailSent ? <>
                  <CardHeader>
                    <CardTitle className="text-2xl font-medium text-white text-center">Reset your password</CardTitle>
                  ...
                  <CardContent className="space-y-4 text-center px-8">
                    ...
                    <Button variant="outline" className="w-full bg-white/10 border-white/20 text-white hover:bg-white/20" onClick={() => navigate("/")}>
                      Back to Login
                    </Button>
                  </CardContent>
                </>}
