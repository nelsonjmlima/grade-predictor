  ...
  return (
    ...
    >
      <div className="animate-scale-in text-center p-8 max-w-md">
        ...
        <p className="text-sm md:text-lg text-gray-200 mt-6 mb-8 whitespace-nowrap overflow-hidden text-ellipsis">Analyze GitLab metrics to predict students grades</p>
